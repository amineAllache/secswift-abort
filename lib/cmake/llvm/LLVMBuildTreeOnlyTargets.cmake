...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/not"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/UnicodeNameMappingGenerator"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/yaml-bench"
  )
...
set_target_properties(split-file PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/split-file"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/lib/BugpointPasses.so"
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/bin/yaml2obj"
  )
...
set_target_properties(ExampleIRTransforms PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/lib/ExampleIRTransforms.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/lib/Bye.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(InlineAdvisorPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/unittests/Analysis/InlineAdvisorPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(InlineOrderPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/unittests/Analysis/InlineOrderPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/unittests/Passes/Plugins/TestPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(DoublerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/amine/build/bolt-fresh/unittests/Passes/Plugins/DoublerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
