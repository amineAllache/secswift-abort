# Autogenerated from /home/amine/projet/llvm-bolt19/llvm-project/llvm/test/Unit/lit.site.cfg.py.in
# Do not edit!
...
config.llvm_src_root = path(r"../../../../projet/llvm-bolt19/llvm-project/llvm")
